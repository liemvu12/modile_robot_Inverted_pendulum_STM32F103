...
{ 	
  ...
  GPIO_InitTypeDef GPIO_InitStructure;                  //定义一个引脚初始化的结构体
	...
	GPIO_InitStructure.GPIO_Speed=GPIO_Speed_2MHz; //引脚输出速度为2MHZ
	GPIO_Init(GPIOB, &GPIO_InitStructure); //根据上面设置好的GPIO_InitStructure参数，初始化引脚GPIOB_PIN3,4,5
	
	GPIO_InitStructure.GPIO_Pin= GPIO_Pin_14;      //引脚14
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_Out_PP; //引脚输入输出模式为推挽输出模式
	GPIO_InitStructure.GPIO_Speed=GPIO_Speed_2MHz; //引脚输出速度为2MHZ
	GPIO_Init(GPIOC, &GPIO_InitStructure); //根据上面设置好的GPIO_InitStructure参数，初始化引脚GPIOC_PIN14
